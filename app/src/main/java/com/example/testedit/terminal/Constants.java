...
public class Constants{
        ...
        public static final List<String> TERMUX_PREFIX_DIR_IGNORED_SUB_FILES_PATHS_TO_CONSIDER_AS_EMPTY = Arrays.asList(
                Constants.TERMUX_TMP_PREFIX_DIR_PATH, Constants.TERMUX_ENV_TEMP_FILE_PATH, Constants.TERMUX_ENV_FILE_PATH);
        ...
        public static final String TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_NAME = Constants.TERMUX_APP_NAME + " RunCommandService";
        ...
        public static final String TERMUX_PLUGIN_COMMAND_ERRORS_NOTIFICATION_CHANNEL_NAME = Constants.TERMUX_APP_NAME + " Plugin Commands Errors";
        ...
        public static final String TERMUX_CRASH_REPORTS_NOTIFICATION_CHANNEL_NAME = Constants.TERMUX_APP_NAME + " Crash Reports";
        ...
        public static final String TERMUX_FLOAT_APP_NOTIFICATION_CHANNEL_NAME = Constants.TERMUX_FLOAT_APP_NAME + " App";
        /** Termux app unique notification id used by {@link TERMUX_APP.TERMUX_SERVICE} */
...
public static final class TERMUX_APP {
    ...
    public static final class TERMUX_ACTIVITY {
        ...
        public static final String EXTRA_FAILSAFE_SESSION = Constants.TERMUX_PACKAGE_NAME + ".app.failsafe_session"; // Default: "com.termux.app.failsafe_session"


        /** Intent action to make termux app notify user that a crash happened. */
        public static final String ACTION_NOTIFY_APP_CRASH = Constants.TERMUX_PACKAGE_NAME + ".app.notify_app_crash"; // Default: "com.termux.app.notify_app_crash"


        /** Intent action to make termux reload its termux session styling */
        public static final String ACTION_RELOAD_STYLE = Constants.TERMUX_PACKAGE_NAME + ".app.reload_style"; // Default: "com.termux.app.reload_style"
        /** Intent {@code String} extra for what to reload for the TERMUX_ACTIVITY.ACTION_RELOAD_STYLE intent. This has been deperecated. */
        @Deprecated
        public static final String EXTRA_RELOAD_STYLE = Constants.TERMUX_PACKAGE_NAME + ".app.reload_style"; // Default: "com.termux.app.reload_style"
        ...
        public static final String ACTION_REQUEST_PERMISSIONS = Constants.TERMUX_PACKAGE_NAME + ".app.request_storage_permissions"; // Default: "com.termux.app.request_storage_permissions"
    }
